Copyright (c) 2020-2021 Himalaglebruhv
# Import.
...
while True:
    ...
    print("█▀▄ █▀▄ █▀█ █▀
    print("█▄▀ █▄▀ █▄█ ▄█
print("                     Author: Himalaglebruhv27 \033[91mRed\033[0m")
    print("       Github: https://github.com/Himalagle-exc27/Raven-DDOS")
    print('The creator of this script not take the risk for legal purposes only')
    print("\033[92;1m")
